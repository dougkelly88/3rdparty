...
ArtemisHandle artfn ArtemisConnect(int Device)
{
	...
	{
		if (NULL == pFuncs[9])
			pFuncs[9]=GetProcAddress(hArtemisDLL, "ArtemisConnect");
		TYPE_ARTEMISCONNECT pArtemisConnect=(TYPE_ARTEMISCONNECT)pFuncs[9];
...
int artfn ArtemisCoolerWarmUp(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[10])
			pFuncs[10]=GetProcAddress(hArtemisDLL, "ArtemisCoolerWarmUp");
		TYPE_ARTEMISCOOLERWARMUP pArtemisCoolerWarmUp=(TYPE_ARTEMISCOOLERWARMUP)pFuncs[10];
...
int artfn ArtemisCoolingInfo(ArtemisHandle hCam, int* flags, int* level, int* minlvl, int* maxlvl, int* setpoint)
{
	...
	{
		if (NULL == pFuncs[11])
			pFuncs[11]=GetProcAddress(hArtemisDLL, "ArtemisCoolingInfo");
		TYPE_ARTEMISCOOLINGINFO pArtemisCoolingInfo=(TYPE_ARTEMISCOOLINGINFO)pFuncs[11];
...
bool artfn ArtemisDeviceIsCamera(int Device)
{
	...
	{
		if (NULL == pFuncs[12])
			pFuncs[12]=GetProcAddress(hArtemisDLL, "ArtemisDeviceIsCamera");
		TYPE_ARTEMISDEVICEISCAMERA pArtemisDeviceIsCamera=(TYPE_ARTEMISDEVICEISCAMERA)pFuncs[12];
...
bool artfn ArtemisDeviceName(int Device, char * pName)
{
	...
	{
		if (NULL == pFuncs[13])
			pFuncs[13]=GetProcAddress(hArtemisDLL, "ArtemisDeviceName");
		TYPE_ARTEMISDEVICENAME pArtemisDeviceName=(TYPE_ARTEMISDEVICENAME)pFuncs[13];
...
bool artfn ArtemisDeviceSerial(int Device, char * pName)
{
	...
	{
		if (NULL == pFuncs[14])
			pFuncs[14]=GetProcAddress(hArtemisDLL, "ArtemisDeviceSerial");
		TYPE_ARTEMISDEVICESERIAL pArtemisDeviceSerial=(TYPE_ARTEMISDEVICESERIAL)pFuncs[14];
...
bool artfn ArtemisDisconnect(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[15])
			pFuncs[15]=GetProcAddress(hArtemisDLL, "ArtemisDisconnect");
		TYPE_ARTEMISDISCONNECT pArtemisDisconnect=(TYPE_ARTEMISDISCONNECT)pFuncs[15];
...
bool artfn ArtemisDisconnectAll()
{
	...
	{
		if (NULL == pFuncs[16])
			pFuncs[16]=GetProcAddress(hArtemisDLL, "ArtemisDisconnectAll");
		TYPE_ARTEMISDISCONNECTALL pArtemisDisconnectAll=(TYPE_ARTEMISDISCONNECTALL)pFuncs[16];
...
int artfn ArtemisDownloadPercent(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[17])
			pFuncs[17]=GetProcAddress(hArtemisDLL, "ArtemisDownloadPercent");
		TYPE_ARTEMISDOWNLOADPERCENT pArtemisDownloadPercent=(TYPE_ARTEMISDOWNLOADPERCENT)pFuncs[17];
...
int artfn ArtemisExposureReadyCallback(ArtemisHandle hCam, HWND hWnd, int msg, int wParam, int lParam)
{
	...
	{
		if (NULL == pFuncs[18])
			pFuncs[18]=GetProcAddress(hArtemisDLL, "ArtemisExposureReadyCallback");
		TYPE_ARTEMISEXPOSUREREADYCALLBACK pArtemisExposureReadyCallback=(TYPE_ARTEMISEXPOSUREREADYCALLBACK)pFuncs[18];
...
float artfn ArtemisExposureTimeRemaining(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[19])
			pFuncs[19]=GetProcAddress(hArtemisDLL, "ArtemisExposureTimeRemaining");
		TYPE_ARTEMISEXPOSURETIMEREMAINING pArtemisExposureTimeRemaining=(TYPE_ARTEMISEXPOSURETIMEREMAINING)pFuncs[19];
...
bool artfn ArtemisGetAmplifierSwitched(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[20])
			pFuncs[20]=GetProcAddress(hArtemisDLL, "ArtemisGetAmplifierSwitched");
		TYPE_ARTEMISGETAMPLIFIERSWITCHED pArtemisGetAmplifierSwitched=(TYPE_ARTEMISGETAMPLIFIERSWITCHED)pFuncs[20];
...
int artfn ArtemisGetBin(ArtemisHandle hCam, int * x, int * y)
{
	...
	{
		if (NULL == pFuncs[21])
			pFuncs[21]=GetProcAddress(hArtemisDLL, "ArtemisGetBin");
		TYPE_ARTEMISGETBIN pArtemisGetBin=(TYPE_ARTEMISGETBIN)pFuncs[21];
...
bool artfn ArtemisGetDarkMode(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[22])
			pFuncs[22]=GetProcAddress(hArtemisDLL, "ArtemisGetDarkMode");
		TYPE_ARTEMISGETDARKMODE pArtemisGetDarkMode=(TYPE_ARTEMISGETDARKMODE)pFuncs[22];
...
int artfn ArtemisGetDescription(char * recv, int info, int unit)
{
	...
	{
		if (NULL == pFuncs[23])
			pFuncs[23]=GetProcAddress(hArtemisDLL, "ArtemisGetDescription");
		TYPE_ARTEMISGETDESCRIPTION pArtemisGetDescription=(TYPE_ARTEMISGETDESCRIPTION)pFuncs[23];
...
int artfn ArtemisGetMaxBin(ArtemisHandle hCam, int * x, int * y)
{
	...
	{
		if (NULL == pFuncs[26])
			pFuncs[26]=GetProcAddress(hArtemisDLL, "ArtemisGetMaxBin");
		TYPE_ARTEMISGETMAXBIN pArtemisGetMaxBin=(TYPE_ARTEMISGETMAXBIN)pFuncs[26];
...
int artfn ArtemisGetProcessing(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[27])
			pFuncs[27]=GetProcAddress(hArtemisDLL, "ArtemisGetProcessing");
		TYPE_ARTEMISGETPROCESSING pArtemisGetProcessing=(TYPE_ARTEMISGETPROCESSING)pFuncs[27];
...
int artfn ArtemisGetSubframe(ArtemisHandle hCam, int * x, int * y, int * w, int * h)
{
	...
	{
		if (NULL == pFuncs[28])
			pFuncs[28]=GetProcAddress(hArtemisDLL, "ArtemisGetSubframe");
		TYPE_ARTEMISGETSUBFRAME pArtemisGetSubframe=(TYPE_ARTEMISGETSUBFRAME)pFuncs[28];
...
int artfn ArtemisGuide(ArtemisHandle hCam, int axis)
{
	...
	{
		if (NULL == pFuncs[29])
			pFuncs[29]=GetProcAddress(hArtemisDLL, "ArtemisGuide");
		TYPE_ARTEMISGUIDE pArtemisGuide=(TYPE_ARTEMISGUIDE)pFuncs[29];
...
int artfn ArtemisGuidePort(ArtemisHandle hCam, int nibble)
{
	...
	{
		if (NULL == pFuncs[30])
			pFuncs[30]=GetProcAddress(hArtemisDLL, "ArtemisGuidePort");
		TYPE_ARTEMISGUIDEPORT pArtemisGuidePort=(TYPE_ARTEMISGUIDEPORT)pFuncs[30];
...
int artfn ArtemisHighPriority(ArtemisHandle hCam, bool bHigh)
{
	...
	{
		if (NULL == pFuncs[31])
			pFuncs[31]=GetProcAddress(hArtemisDLL, "ArtemisHighPriority");
		TYPE_ARTEMISHIGHPRIORITY pArtemisHighPriority=(TYPE_ARTEMISHIGHPRIORITY)pFuncs[31];
...
void* artfn ArtemisImageBuffer(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[32])
			pFuncs[32]=GetProcAddress(hArtemisDLL, "ArtemisImageBuffer");
		TYPE_ARTEMISIMAGEBUFFER pArtemisImageBuffer=(TYPE_ARTEMISIMAGEBUFFER)pFuncs[32];
...
bool artfn ArtemisIsConnected(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[34])
			pFuncs[34]=GetProcAddress(hArtemisDLL, "ArtemisIsConnected");
		TYPE_ARTEMISISCONNECTED pArtemisIsConnected=(TYPE_ARTEMISISCONNECTED)pFuncs[34];
...
float artfn ArtemisLastExposureDuration(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[35])
			pFuncs[35]=GetProcAddress(hArtemisDLL, "ArtemisLastExposureDuration");
		TYPE_ARTEMISLASTEXPOSUREDURATION pArtemisLastExposureDuration=(TYPE_ARTEMISLASTEXPOSUREDURATION)pFuncs[35];
...
char* artfn ArtemisLastStartTime(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[36])
			pFuncs[36]=GetProcAddress(hArtemisDLL, "ArtemisLastStartTime");
		TYPE_ARTEMISLASTSTARTTIME pArtemisLastStartTime=(TYPE_ARTEMISLASTSTARTTIME)pFuncs[36];
...
int artfn ArtemisLastStartTimeMilliseconds(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[37])
			pFuncs[37]=GetProcAddress(hArtemisDLL, "ArtemisLastStartTimeMilliseconds");
		TYPE_ARTEMISLASTSTARTTIMEMILLISECONDS pArtemisLastStartTimeMilliseconds=(TYPE_ARTEMISLASTSTARTTIMEMILLISECONDS)pFuncs[37];
...
int artfn ArtemisPeek(ArtemisHandle hCam, int peekCode, int* peekValue)
{
	...
	{
		if (NULL == pFuncs[38])
			pFuncs[38]=GetProcAddress(hArtemisDLL, "ArtemisPeek");
		TYPE_ARTEMISPEEK pArtemisPeek=(TYPE_ARTEMISPEEK)pFuncs[38];
...
int artfn ArtemisPoke(ArtemisHandle hCam, int pokeCode, int pokeValue)
{
	...
	{
		if (NULL == pFuncs[39])
			pFuncs[39]=GetProcAddress(hArtemisDLL, "ArtemisPoke");
		TYPE_ARTEMISPOKE pArtemisPoke=(TYPE_ARTEMISPOKE)pFuncs[39];
...
int artfn ArtemisPrechargeMode(ArtemisHandle hCam, int mode)
{
	...
	{
		if (NULL == pFuncs[40])
			pFuncs[40]=GetProcAddress(hArtemisDLL, "ArtemisPrechargeMode");
		TYPE_ARTEMISPRECHARGEMODE pArtemisPrechargeMode=(TYPE_ARTEMISPRECHARGEMODE)pFuncs[40];
...
int artfn ArtemisProperties(ArtemisHandle hCam, struct ARTEMISPROPERTIES * pProp)
{
	...
	{
		if (NULL == pFuncs[41])
			pFuncs[41]=GetProcAddress(hArtemisDLL, "ArtemisProperties");
		TYPE_ARTEMISPROPERTIES pArtemisProperties=(TYPE_ARTEMISPROPERTIES)pFuncs[41];
...
int artfn ArtemisPulseGuide(ArtemisHandle hCam, int axis, int milli)
{
	...
	{
		if (NULL == pFuncs[42])
			pFuncs[42]=GetProcAddress(hArtemisDLL, "ArtemisPulseGuide");
		TYPE_ARTEMISPULSEGUIDE pArtemisPulseGuide=(TYPE_ARTEMISPULSEGUIDE)pFuncs[42];
...
int artfn ArtemisSetCooling(ArtemisHandle hCam, int setpoint)
{
	...
	{
		if (NULL == pFuncs[44])
			pFuncs[44]=GetProcAddress(hArtemisDLL, "ArtemisSetCooling");
		TYPE_ARTEMISSETCOOLING pArtemisSetCooling=(TYPE_ARTEMISSETCOOLING)pFuncs[44];
...
int artfn ArtemisSetDarkMode(ArtemisHandle hCam, bool bEnable)
{
	...
	{
		if (NULL == pFuncs[45])
			pFuncs[45]=GetProcAddress(hArtemisDLL, "ArtemisSetDarkMode");
		TYPE_ARTEMISSETDARKMODE pArtemisSetDarkMode=(TYPE_ARTEMISSETDARKMODE)pFuncs[45];
...
int artfn ArtemisSetProcessing(ArtemisHandle hCam, int options)
{
	...
	{
		if (NULL == pFuncs[47])
			pFuncs[47]=GetProcAddress(hArtemisDLL, "ArtemisSetProcessing");
		TYPE_ARTEMISSETPROCESSING pArtemisSetProcessing=(TYPE_ARTEMISSETPROCESSING)pFuncs[47];
...
int artfn ArtemisStartExposure(ArtemisHandle hCam, float Seconds)
{
	...
	{
		if (NULL == pFuncs[48])
			pFuncs[48]=GetProcAddress(hArtemisDLL, "ArtemisStartExposure");
		TYPE_ARTEMISSTARTEXPOSURE pArtemisStartExposure=(TYPE_ARTEMISSTARTEXPOSURE)pFuncs[48];
...
int artfn ArtemisStopExposure(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[49])
			pFuncs[49]=GetProcAddress(hArtemisDLL, "ArtemisStopExposure");
		TYPE_ARTEMISSTOPEXPOSURE pArtemisStopExposure=(TYPE_ARTEMISSTOPEXPOSURE)pFuncs[49];
...
int artfn ArtemisStopGuiding(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[50])
			pFuncs[50]=GetProcAddress(hArtemisDLL, "ArtemisStopGuiding");
		TYPE_ARTEMISSTOPGUIDING pArtemisStopGuiding=(TYPE_ARTEMISSTOPGUIDING)pFuncs[50];
...
int artfn ArtemisStopGuidingBeforeDownload(ArtemisHandle hCam, bool bEnable)
{
	...
	{
		if (NULL == pFuncs[51])
			pFuncs[51]=GetProcAddress(hArtemisDLL, "ArtemisStopGuidingBeforeDownload");
		TYPE_ARTEMISSTOPGUIDINGBEFOREDOWNLOAD pArtemisStopGuidingBeforeDownload=(TYPE_ARTEMISSTOPGUIDINGBEFOREDOWNLOAD)pFuncs[51];
...
int artfn ArtemisSubframe(ArtemisHandle hCam, int x, int y, int w, int h)
{
	...
	{
		if (NULL == pFuncs[52])
			pFuncs[52]=GetProcAddress(hArtemisDLL, "ArtemisSubframe");
		TYPE_ARTEMISSUBFRAME pArtemisSubframe=(TYPE_ARTEMISSUBFRAME)pFuncs[52];
...
int artfn ArtemisSubframePos(ArtemisHandle hCam, int x, int y)
{
	...
	{
		if (NULL == pFuncs[53])
			pFuncs[53]=GetProcAddress(hArtemisDLL, "ArtemisSubframePos");
		TYPE_ARTEMISSUBFRAMEPOS pArtemisSubframePos=(TYPE_ARTEMISSUBFRAMEPOS)pFuncs[53];
...
int artfn ArtemisSubframeSize(ArtemisHandle hCam, int w, int h)
{
	...
	{
		if (NULL == pFuncs[54])
			pFuncs[54]=GetProcAddress(hArtemisDLL, "ArtemisSubframeSize");
		TYPE_ARTEMISSUBFRAMESIZE pArtemisSubframeSize=(TYPE_ARTEMISSUBFRAMESIZE)pFuncs[54];
...
int artfn ArtemisTemperatureSensorInfo(ArtemisHandle hCam, int sensor, int* temperature)
{
	...
	{
		if (NULL == pFuncs[55])
			pFuncs[55]=GetProcAddress(hArtemisDLL, "ArtemisTemperatureSensorInfo");
		TYPE_ARTEMISTEMPERATURESENSORINFO pArtemisTemperatureSensorInfo=(TYPE_ARTEMISTEMPERATURESENSORINFO)pFuncs[55];
...
bool artfn ArtemisCanOverlapExposures(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[56])
			pFuncs[56]=GetProcAddress(hArtemisDLL, "ArtemisCanOverlapExposures");
		TYPE_ARTEMISCANOVERLAPEXPOSURES pArtemisCanOverlapExposures=(TYPE_ARTEMISCANOVERLAPEXPOSURES)pFuncs[56];
...
bool artfn ArtemisContinuousExposingModeSupported(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[57])
			pFuncs[57]=GetProcAddress(hArtemisDLL, "ArtemisContinuousExposingModeSupported");
		TYPE_ARTEMISCONTINUOUSEXPOSINGMODESUPPORTED pArtemisContinuousExposingModeSupported=(TYPE_ARTEMISCONTINUOUSEXPOSINGMODESUPPORTED)pFuncs[57];
...
bool artfn ArtemisGetContinuousExposingMode(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[58])
			pFuncs[58]=GetProcAddress(hArtemisDLL, "ArtemisGetContinuousExposingMode");
		TYPE_ARTEMISGETCONTINUOUSEXPOSINGMODE pArtemisGetContinuousExposingMode=(TYPE_ARTEMISGETCONTINUOUSEXPOSINGMODE)pFuncs[58];
...
int artfn ArtemisGetGpioInformation(ArtemisHandle hCam, int* lineCount, int* lineValues)
{
	...
	{
		if (NULL == pFuncs[59])
			pFuncs[59]=GetProcAddress(hArtemisDLL, "ArtemisGetGpioInformation");
		TYPE_ARTEMISGETGPIOINFORMATION pArtemisGetGpioInformation=(TYPE_ARTEMISGETGPIOINFORMATION)pFuncs[59];
...
bool artfn ArtemisOverlappedExposureValid(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[60])
			pFuncs[60]=GetProcAddress(hArtemisDLL, "ArtemisOverlappedExposureValid");
		TYPE_ARTEMISOVERLAPPEDEXPOSUREVALID pArtemisOverlappedExposureValid=(TYPE_ARTEMISOVERLAPPEDEXPOSUREVALID)pFuncs[60];
...
int artfn ArtemisSetContinuousExposingMode(ArtemisHandle hCam, bool bEnable)
{
	...
	{
		if (NULL == pFuncs[61])
			pFuncs[61]=GetProcAddress(hArtemisDLL, "ArtemisSetContinuousExposingMode");
		TYPE_ARTEMISSETCONTINUOUSEXPOSINGMODE pArtemisSetContinuousExposingMode=(TYPE_ARTEMISSETCONTINUOUSEXPOSINGMODE)pFuncs[61];
...
int artfn ArtemisSetGpioDirection(ArtemisHandle hCam, int directionMask)
{
	...
	{
		if (NULL == pFuncs[62])
			pFuncs[62]=GetProcAddress(hArtemisDLL, "ArtemisSetGpioDirection");
		TYPE_ARTEMISSETGPIODIRECTION pArtemisSetGpioDirection=(TYPE_ARTEMISSETGPIODIRECTION)pFuncs[62];
...
int artfn ArtemisSetGpioValues(ArtemisHandle hCam, int lineValues)
{
	...
	{
		if (NULL == pFuncs[63])
			pFuncs[63]=GetProcAddress(hArtemisDLL, "ArtemisSetGpioValues");
		TYPE_ARTEMISSETGPIOVALUES pArtemisSetGpioValues=(TYPE_ARTEMISSETGPIOVALUES)pFuncs[63];
...
int artfn ArtemisSetOverlappedExposureTime(ArtemisHandle hCam, float Seconds)
{
	...
	{
		if (NULL == pFuncs[64])
			pFuncs[64]=GetProcAddress(hArtemisDLL, "ArtemisSetOverlappedExposureTime");
		TYPE_ARTEMISSETOVERLAPPEDEXPOSURETIME pArtemisSetOverlappedExposureTime=(TYPE_ARTEMISSETOVERLAPPEDEXPOSURETIME)pFuncs[64];
...
int artfn ArtemisSetOversample(ArtemisHandle hCam, int oversample)
{
	...
	{
		if (NULL == pFuncs[65])
			pFuncs[65]=GetProcAddress(hArtemisDLL, "ArtemisSetOversample");
		TYPE_ARTEMISSETOVERSAMPLE pArtemisSetOversample=(TYPE_ARTEMISSETOVERSAMPLE)pFuncs[65];
...
int artfn ArtemisSetSubSample(ArtemisHandle hCam, bool bSub)
{
	...
	{
		if (NULL == pFuncs[66])
			pFuncs[66]=GetProcAddress(hArtemisDLL, "ArtemisSetSubSample");
		TYPE_ARTEMISSETSUBSAMPLE pArtemisSetSubSample=(TYPE_ARTEMISSETSUBSAMPLE)pFuncs[66];
...
int artfn ArtemisStartOverlappedExposure(ArtemisHandle hCam)
{
	...
	{
		if (NULL == pFuncs[67])
			pFuncs[67]=GetProcAddress(hArtemisDLL, "ArtemisStartOverlappedExposure");
		TYPE_ARTEMISSTARTOVERLAPPEDEXPOSURE pArtemisStartOverlappedExposure=(TYPE_ARTEMISSTARTOVERLAPPEDEXPOSURE)pFuncs[67];
...
int artfn ArtemisTriggeredExposure(ArtemisHandle hCam, bool bAwaitTrigger)
{
	...
	{
		if (NULL == pFuncs[68])
			pFuncs[68]=GetProcAddress(hArtemisDLL, "ArtemisTriggeredExposure");
		TYPE_ARTEMISTRIGGEREDEXPOSURE pArtemisTriggeredExposure=(TYPE_ARTEMISTRIGGEREDEXPOSURE)pFuncs[68];
...
int artfn ArtemisSetWindowHeaterPower(ArtemisHandle hCam, int windowHeaterPower)
{
	...
	{
		if (NULL == pFuncs[69])
			pFuncs[69]=GetProcAddress(hArtemisDLL, "ArtemisSetWindowHeaterPower");
		TYPE_ARTEMISSETWINDOWHEATERPOWER pArtemisSetWindowHeaterPower=(TYPE_ARTEMISSETWINDOWHEATERPOWER)pFuncs[69];
...
int artfn ArtemisGetWindowHeaterPower(ArtemisHandle hCam, int* windowHeaterPower)
{
	...
	{
		if (NULL == pFuncs[70])
			pFuncs[70]=GetProcAddress(hArtemisDLL, "ArtemisGetWindowHeaterPower");
		TYPE_ARTEMISGETWINDOWHEATERPOWER pArtemisGetWindowHeaterPower=(TYPE_ARTEMISGETWINDOWHEATERPOWER)pFuncs[70];
