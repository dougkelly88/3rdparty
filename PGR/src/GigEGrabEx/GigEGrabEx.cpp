...
void PrintCameraInfo( CameraInfo* pCamInfo )
{
	...
	macAddress << hex << setw(2) << setfill('0') << pCamInfo->macAddress.octets[0] << ":" << 
				  hex << setw(2) << setfill('0') << pCamInfo->macAddress.octets[1] << ":" << 
				  hex << setw(2) << setfill('0') << pCamInfo->macAddress.octets[2] << ":" << 
				  hex << setw(2) << setfill('0') << pCamInfo->macAddress.octets[3] << ":" << 
				  hex << setw(2) << setfill('0') << pCamInfo->macAddress.octets[4] << ":" << 
				  hex << setw(2) << setfill('0') << pCamInfo->macAddress.octets[5];
    

    ostringstream ipAddress;
	ipAddress << pCamInfo->ipAddress.octets[0] << "." << 
				 pCamInfo->ipAddress.octets[1] << "." << 
				 pCamInfo->ipAddress.octets[2] << "." << 
				 pCamInfo->ipAddress.octets[3];
	
    ostringstream subnetMask;
	subnetMask << pCamInfo->subnetMask.octets[0] << "." << 
				  pCamInfo->subnetMask.octets[1] << "." << 
				  pCamInfo->subnetMask.octets[2] << "." << 
				  pCamInfo->subnetMask.octets[3];
	
    ostringstream defaultGateway;
	defaultGateway << pCamInfo->defaultGateway.octets[0] << "." << 
...
void PrintStreamChannelInfo( GigEStreamChannel* pStreamChannel )
{
    //char ipAddress[32];
    ostringstream ipAddress;
	ipAddress << pStreamChannel->destinationIpAddress.octets[0] << "." << 
